...
MEANING = {
    ...
    "plan_vs_actual": "a planned or budgeted figure next to the actual one for a quarter or a year (ARR, net new ARR, net burn, headcount), or a goal of a previous round and what was reached",
    "net_price": "the net price paid against the list price, per contract or on average",
    "discount_rate": "discounts granted, average discount rate, or its trend",
    "fcf_margin": "free cash flow margin, free cash flow over revenue, over a period",
    "zero_burn_growth": "the growth the model forecasts with spending frozen at the level the cash on hand allows",
    "product_share": "share of ARR or new ARR made by a product after the first, with its economics",
    "geo_share": "share of ARR or new ARR made outside the home country, with its economics",
    "liquidation_preference": "liquidation preference of a round: multiple, participation, seniority, ratchet",
    "debt_terms": "the terms of a debt line: amount, rate, maturity, covenants, warrants, security",
